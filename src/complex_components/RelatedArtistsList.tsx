...
import { useSimilarArtistsQuery } from '../queries';
...
const RelatedArtistsList: React.FC<RelatedArtistsListProps> = (props) => {
  ...
  const { data, isLoading } = useSimilarArtistsQuery(artistId);
